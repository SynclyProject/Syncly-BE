...
public class RoomExpirationWorker {
    ...
    public void consume() {
        ...
        for (Object obj : expiredRoomIds) {
            ...
            roomStateService.removeRoomAllData(roomId); // ZSet에서 삭제
        }
    }
}